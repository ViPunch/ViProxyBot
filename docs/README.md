...
```
Phase 1:
  1. docs/00-overview-and-architecture.md   — архитектура, домен, контракты
  2. docs/phase-1-mvp.md                     — бизнес-описание Phase 1
  3. docs/phase-1-playbook.md                — шаги реализации Phase 1

Phase 2:
  4. docs/phase-2-expansion.md               — бизнес-описание Phase 2
  5. docs/phase-2-playbook.md                — шаги реализации Phase 2

Phase 3:
  6. docs/phase-3-production.md              — бизнес-описание Phase 3
  7. docs/phase-3-playbook.md                — шаги реализации Phase 3
```
